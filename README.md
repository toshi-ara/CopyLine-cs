...
5. 貼り付けたいアプリケーションに移動して
   **Ctrl-V** を押すとキューの先頭の要素から順番に貼り付けられます
    + 貼り付け後はキューの内容が1つずつ繰り上がります
...
6. キューに要素が残っている場合でも、
   ...
   Ctrl-V でその内容を貼り付けることができます
    ...
    + 間違えた場所に貼り付けた場合に有効です
    + 貼り付け後はキューの先頭要素がクリップボードに格納されます

<img src="image/Program_copy.png" alt="手動コピー後">
...
<img src="image/flowchart.png" alt="フローチャート">
